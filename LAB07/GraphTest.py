...
graph.show()
print()
graph.add(2,"0: v0","1: v1")
graph.add(2,"0: v0","5: v5")
graph.add(2,"2: v2","3: v3")
graph.add(2,"2: v2","1: v1")
graph.add(2,"3: v3","4: v4")
graph.add(2,"4: v4","1: v1")
graph.add(2,"4: v4","5: v5")
graph.add(2,"5: v5","1: v1")
graph.add(2,"5: v5","2: v2")
graph.print()
